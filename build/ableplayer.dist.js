  ...
  AblePlayer.prototype.getAvailablePreferences = function() {
    ...
    if (this.mediaType === 'video') { // features prefs apply only to video
      prefs.push({
        ...
        'default': 0 // on because many users can benefit
      });
    ...
    var addCaption = function(div, cap) {
      ...
      var flattenComponentForCaption = function(comp) {
        ...
        var flattenString = function (str) {
          ...
          // JC: disable parenthesis matching
          var hasParens = false;

          var escapedOpenBracket = str.indexOf('\\[');
          var escapedCloseBracket = str.indexOf('\\]');
